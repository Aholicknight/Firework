...
extends Module {
    ...
    public void onPacket(PacketEvent.Receive e) {
        ...
        if (e.getPacket() instanceof SPacketEffect) {
            SPacketEffect effect = (SPacketEffect)((Object)e.getPacket());
            ...
            if (this.mc.player.getPosition().getDistance(effect.getSoundPos().getX(), effect.getSoundPos().getY(), effect.getSoundPos().getZ()) > 500.0 + this.mc.player.posY) {
                ...
                SPacketSoundEffect sound = (SPacketSoundEffect)((Object)e.getPacket());
                ...
                SPacketSpawnGlobalEntity lightning = (SPacketSpawnGlobalEntity)((Object)e.getPacket());
