...
extends Command {
    ...
    public void execute(String[] args) {
        ...
        ITextComponent msg1 = new TextComponentString(ChatFormatting.RED + "[CLICKABLE] Next Page >>>").setStyle(new Style().setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, CommandManager.prefix + "help4")));
