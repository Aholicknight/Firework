...
public class MessageUtil {
    ...
    public static void sendClientMessage(String string, boolean deleteOld) {
        ...
        TextComponentString component = new TextComponentString(prefix + ChatFormatting.GRAY + string + ChatFormatting.RESET);
        if (deleteOld) {
    ...
    public static void sendError(String string, int id) {
        ...
        TextComponentString component = new TextComponentString(prefix + ChatFormatting.RED + string + ChatFormatting.RESET);
        Minecraft.getMinecraft().ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(component, id);
    }
    ...
    public static void warning(String string, int id) {
        ...
        TextComponentString component = new TextComponentString(prefix + ChatFormatting.YELLOW + string + ChatFormatting.RESET);
        Minecraft.getMinecraft().ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(component, id);
    }
    ...
    public static void sendShifrText(ITextComponent string, int id) {
        ...
        TextComponentString component = new TextComponentString(prefix + ChatFormatting.DARK_BLUE + string + ChatFormatting.RESET);
        Minecraft.getMinecraft().ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(component, id);
    }
}
